				  ...
				  <div>
				    <header>
				      <div class="am-comment-meta qustion-title-content">
				        <a href="<?php echo GetUserPage($vo['answer_author']);?>" class="am-comment-author"><?php echo $vo['answer_author'];?></a>
				        发布于 <time><?php echo $vo['time'];?></time>
				      </div>
				    </header>
				    <div class="am-comment-bd">
				    <a class="qustion-title-content am-text-truncate" target="_blank" href="/index.php/Home/Question/<?php echo $vo['answer_question_id'];?>/Answer/<?php echo $vo['answer_id'];?>"><h2><?php echo get_question_title($vo['answer_question_id']);?></h2></a>
