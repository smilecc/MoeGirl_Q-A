<?php if (!defined('THINK_PATH')) exit();?>	<?php if(is_array($timeline)): foreach($timeline as $i=>$vo): if(count($vo['us_array']) == 1): ?><a target="_blank" href="<?php echo GetUserPage($vo['fromusername']);?>" class="am-comment-author"><?php echo $vo['fromusername'];?></a>
      ...
      <span> 赞同了你在问题 </span>
      <strong><a target="_blank" href="/index.php/Home/Question/<?php echo $vo['question_id'];?>/Answer/<?php echo $vo['answer_id'];?>"><?php echo get_question_title($vo['question_id']);?></a></strong><span> 下的回答</span>
