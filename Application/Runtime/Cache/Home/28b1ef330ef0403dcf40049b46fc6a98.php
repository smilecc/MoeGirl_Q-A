<?php if (!defined('THINK_PATH')) exit();?>	<?php if(is_array($timeline)): foreach($timeline as $i=>$vo): if($vo['mode'] == 2): ?><article class="am-comment">
				    ...
				    <!--<img src="" alt="" class="am-comment-avatar" width="48" height="48"/>-->
					  <div>
					    <header>
					      ...
					      <?php if(count($vo['us_array']) == 1): ?><a target="_blank" href="<?php echo get_user_page($vo['username']);?>" class="am-comment-author"><?php echo $vo['username'];?></a>
					      <?php else: ?>
					    ...
					    <?php if($vo['status'] != 1): ?><a target="_blank" href="<?php echo get_user_page($vo['content']['username']);?>" class="am-comment-author"><?php echo $vo['content']['username'];?></a><br /><?php endif; ?>
			...
			<?php else: ?>
				<small><div class="am-link-muted">
				    <a href="<?php echo get_user_page($vo['username']);?>"><?php echo $vo['username'];?></a>
